      ...
      <div className="w-full px-6 py-10 md:px-16">
        ...
        <div className="mb-10 border-b border-slate-200 pb-8">
          ...
          <h1 className="mt-2 text-4xl font-bold tracking-tight text-slate-900 sm:text-6xl md:text-7xl">
            ...
            <span className="text-[#5a4bff]">matter.</span>
          </h1>

          <p className="mt-4 max-w-2xl text-base text-slate-600 sm:text-lg">
            Tell us about your project or vision, and let&apos;s build
        ...
        <div className="grid w-full grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-white p-8 shadow-sm sm:p-12 lg:col-span-5">
            <div>
              ...
              <p className="mt-4 text-base leading-relaxed text-slate-600">
                Reach out to us directly for quick discussions, quotes, or
                general inquiries. We are happy to help you get started.
              </p>
            </div>
