      ...
      <div className='mx-auto w-[96vw] max-w-[1320px]'>
        <div className='grid min-h-[620px] grid-cols-1 items-start gap-8 pt-6 lg:grid-cols-[0.95fr_1.25fr]'>
          ...
          >
            ...
            <h2 className='mt-2 text-[64px] italic font-medium leading-none text-[#5a4bff] lg:text-[72px]'>
              Brand Futures,
            </h2>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className='mt-10 inline-flex items-center gap-3 bg-black px-8 py-4 text-[22px] font-semibold text-white shadow-[4px_4px_0_0_#5a4bff]'
            >
              Enquire Now
        ...
        {/* Bottom line exactly like the designer PDF */}
